...
| 寫手 | 目前任務 | 狀態 |
|---|---|---|
| 寫手1 | **Act4〈三條路〉正文動筆中**（11章，古界Act1~4最後一幕，接續Act1~3） | ✅ **Act3〈戰爭〉全15章完稿**（`novel/volume04_v2/chapter021~035.md`），累計完成35/46章。柁婆之死（ch034）比照RC-V06決賽規格複核，完整落實「答案不說出口」。第216題（7項場景層級設定）已登記待確認。 |
