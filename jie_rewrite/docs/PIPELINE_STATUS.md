...
| 寫手 | 目前任務 | 狀態 |
|---|---|---|
| 寫手1 | **第215題**：四伴星名稱能力重整影響範圍盤點＋姒月/蒼梧外形設計提案（見`CHECKLIST_PENDING_DECISIONS.md`第215題全文） | ✅ Act1全九章+Act2全十一章已完稿並經PM複核核准（`novel/volume04_v2/chapter001~020.md`），內容本身有效不需重寫，僅ch1鎮無央顯化場景等處後續要跟著215題換物種外形與名字。 |
| 寫手2 | 離線中。最後任務：Act5四格骨架推進到jie-chapter-editor章節大綱層級 | 上線後需同步：①215題四伴星重整；②聽島/鎮界起源問題現況（待使用者裁決）。 |
| 清道夫 | 暫停待命。volume07 ch001~045已完成，ch046~050未開始 | ✅ volume01/02/03_v2/05/06/06b全卷完工＋volume07過半，抓到大量真實bug（meta章節編號洩漏、拳/刀矛盾、煌命色譜誤植、退針數字總量矛盾等，詳見`CHECKLIST_NOVEL_REVIEW_FIXES.md` CB~CE節）。 |

**更新守則**：這張表跟兩份`PIPELINE_WRITERn_LOG.md`必須保持一致——寫手每完成一段就自己補log，PM每次收到回報/commit後就更新這張表，不要等整批任務結束才補記。

## 待使用者裁決事項（現存）

- **第215題**：四伴星名稱能力重整（劫厄/赤翎不變，鎮無央→姒月/魂，玄衡→蒼梧/界），已定案細節見`CHECKLIST_PENDING_DECISIONS.md`第215題，等寫手1盤點影響範圍+外形提案後正式執行。
